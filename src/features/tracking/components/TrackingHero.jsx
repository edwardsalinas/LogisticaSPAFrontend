import { Search, MapPinned, PackageCheck, Truck } from 'lucide-react';
      ...
      <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1.5fr)_minmax(320px,0.95fr)] lg:items-end">
        <div>
          ...
          <h1 className="mt-5 max-w-3xl font-display text-[clamp(2.1rem,5vw,4rem)] font-semibold tracking-[-0.06em] text-white">
            Seguimiento en vivo, excepciones y busqueda universal.
          </h1>
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-slate-300 sm:text-base">
            El layout empareja la vista de busqueda con un mapa vivo para que cada paquete se entienda rapido sin perder contexto geoespacial.
          </p>
        </div>
        <div className="rounded-[1.7rem] border border-white/15 bg-white/5 p-3 sm:p-4 backdrop-blur-xl shadow-2xl">
          <div className="grid grid-cols-4 gap-2 sm:gap-3">
            ...
            <div className="group relative overflow-hidden rounded-[1.35rem] border border-white/20 bg-white/10 p-2 sm:p-3 text-center text-white transition-all duration-300 hover:bg-white/15 hover:shadow-lg hover:-translate-y-0.5">
              ...
              <p className="mt-1 text-[0.45rem] font-bold uppercase tracking-[0.15em] text-white/70">Visib</p>
              <p className="relative mt-0.5 font-display text-xl sm:text-2xl font-bold tracking-[-0.04em]">{visibleCount}</p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-[1.35rem] border border-white/20 bg-white/10 p-2 sm:p-3 text-center text-white transition-all duration-300 hover:bg-white/15 hover:shadow-lg hover:-translate-y-0.5">
              ...
              <p className="mt-1 text-[0.45rem] font-bold uppercase tracking-[0.15em] text-white/70">Actvs</p>
              <p className="relative mt-0.5 font-display text-xl sm:text-2xl font-bold tracking-[-0.04em]">{activeCount}</p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-[1.35rem] border border-white/20 bg-white/10 p-2 sm:p-3 text-center text-white transition-all duration-300 hover:bg-white/15 hover:shadow-lg hover:-translate-y-0.5">
              ...
              <p className="relative mt-0.5 font-display text-xl sm:text-2xl font-bold tracking-[-0.04em]">{pendingCount}</p>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-[1.35rem] border border-white/20 bg-white/10 p-2 sm:p-3 text-center text-white transition-all duration-300 hover:bg-white/15 hover:shadow-lg hover:-translate-y-0.5">
              ...
              <p className="relative mt-0.5 font-display text-xl sm:text-2xl font-bold tracking-[-0.04em]">{deliveredCount}</p>
            </div>
